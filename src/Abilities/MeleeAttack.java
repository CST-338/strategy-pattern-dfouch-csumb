 ...
 * HW3: Strategy Pattern (Abilities.MeleeAttack.java)
 */
public class MeleeAttack implements Attack {
    ...
    /**
     * Constructs the MeleeAttack object by setting the attacker who makes the attack.
     *
    ...
    public Integer attack(Monster target) {
        ...
        return attacker.getStr() - target.getDef(); // return the amount of damage the target took
    }
}